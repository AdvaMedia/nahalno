...
set :scm, :git
set :repository,  "git@bitbucket.org:saratovsource/nahalno.git"

set :user, "hosting_saratovsource"
set :use_sudo, false
set :deploy_to, "/home/hosting_saratovsource/projects/nahalno"
...
set :unicorn_pid, "/var/run/unicorn/nahalno.saratovsource.pid"
